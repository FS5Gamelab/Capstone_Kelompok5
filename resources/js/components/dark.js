...
function toggleDarkTheme() {
  ...
  setTheme(
    document.documentElement.getAttribute("class") === "tw-dark"
      ? "light"
      : "dark",
    false,
  );
...
function setTheme(theme, persist = false) {
  ...
  document.body.classList.toggle("tw-dark", theme === "dark");
  document.documentElement.setAttribute("data-bs-theme", theme);
  document.documentElement.setAttribute("class", "tw-" + theme);
