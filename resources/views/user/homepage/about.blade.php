    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6">
                ...
                <p>Selera Negari adalah restoran keluarga yang menawarkan berbagai macam makanan dan minuman seperti Gado-Gado Nusantara ,Sate Ayam Madura , Tahu Isi Goreng , Mendoan, Nasi Goreng Spesial, dan masih banyak menu lainnya. Selera Negari restoran berusaha memberikan tempat yang nyaman untuk berkumpul bagi para customernya karena Selera Negari, Your Culinary Journey.</p>
            ...
            <div class="col-lg-5">
                <div class="img-wrap">
                    <img src="{{ asset('static/images/samples/banana.jpg') }}" alt="Image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid team mb-5 " style="margin-top: 100px">
    <div class="container">
        ...
        <div class="row g-4">
                ...
                <div class="team-item rounded">
                    ...
                    <div class="team-content text-center py-3 bg-dark rounded-bottom">
                        ...
                        <div class="team-icon">
                            ...
                            <a class="btn btn-square btn-light rounded-circle" href=""><i class="fab fa-facebook"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class=" col-md-5 " style="flex: 0 0 auto; width: 20%;">
                <div class="team-item rounded">
                    <img class="img-fluid rounded-top " src="{{ asset('static/images/faces/5.jpg') }}" alt="">
                    <div class="team-content text-center py-3 bg-dark rounded-bottom">
