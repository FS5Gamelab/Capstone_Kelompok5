    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="tw-flex tw-justify-between row mt-4">
                    <div class="tw-w-1/4 col-md-3">
                    ...
                    <div class="tw-w-1/4 col-md-3">
                        ...
                        <p class="tw-text-gray-700 dark:tw-text-gray-200 text-capitalize">{{ $product->stock }}</p>
                    </div>
                    <div class="tw-w-1/4 col-md-3">
    ...
    @if (!Auth::user() || Auth::user()->role == 'user')
        ...
        <section class="add-to-cart section tw-fixed tw-bottom-0 tw-left-0 tw-right-0 tw-z-50">
            <div
                ...
                <div class="col-5 !tw-text-sm md:!tw-text-2xl tw-font-bold tw-text-start">
                    Price :
