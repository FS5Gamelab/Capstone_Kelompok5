                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <i class="bi bi-eye-fill tw-text-lg"></i>
                                                </div>
                                            </div>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="{{ asset('/static/images/faces/5.jpg') }}">
                                                                </div>
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="card">
                            <div class="card-content py-4 px-5">
                                <div class="d-flex align-items-center ">
                                    <div class="avatar avatar-lg tw-text-nowrap">
                                        <img src="{{ asset('/static/images/faces/1.jpg') }}" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="{{ asset('/static/images/faces/3.jpg') }}">
                                    </div>
                                    <div class="name ms-4">
