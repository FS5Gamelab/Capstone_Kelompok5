        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3 class="tw-text-3xl tw-font-semibold tw-py-4">Account Profile</h3>
                </div>
                        ...
                        <form id="avatar-form" action="/image/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center align-items-center flex-column">
                                    ...
                                    <h3 class="mt-3 text-capitalize !tw-text-lg tw-font-semibold">{{ Auth::user()->name }}
                                    </h3>
                                    <p class="text-small text-capitalize">{{ Auth::user()->role }}</p>
                                </div>
                                <div class="tw-flex tw-items-center tw-justify-end">
                                    <button type="submit" class="btn btn-primary tw-mt-3 !tw-hidden" id="btn-save">
                                        Save Changes
                                    </button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#image").change(function() {
                $('#btn-save').removeClass('!tw-hidden');
