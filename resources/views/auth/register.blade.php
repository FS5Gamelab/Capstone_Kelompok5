                    ...
                    <div class="tw-max-w-md tw-mx-auto tw-text-white">
                        ...
                        <div class="tw-mt-5">
                            <div class="form-group mb-3">
                                <label for="name"
                                    class="tw-font-semibold tw-text-sm tw-text-gray-400 tw-pb-1 tw-block">Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="password_confirmation"
                                    class="tw-font-semibold tw-text-sm tw-text-gray-400 pb-1 tw-block">Password
                                    Confirmation</label>
